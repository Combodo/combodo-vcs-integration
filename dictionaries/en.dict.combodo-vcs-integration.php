...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:VCSWebhook/Attribute:name' => 'Name',
	'Class:VCSWebhook/Attribute:name+' => 'Name of the repository or the organization hosting the webhook - Must exactly match the name defined in the VCS',
