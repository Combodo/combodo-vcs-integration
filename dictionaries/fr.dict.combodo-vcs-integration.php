...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:VCSApplication' => 'Webhook',
	'Class:VCSApplication+' => 'Webhook du système de gestion de versions',
    'Class:VCSApplication/Attribute:type' => 'Type',
    'Class:VCSApplication/Attribute:type+' => 'Type du webhook',
    'Class:VCSApplication/Attribute:type/Value:repository' => 'Dépôt',
    'Class:VCSApplication/Attribute:type/Value:organization' => 'Organisation',
	'Class:VCSApplication/Attribute:name' => 'Etiquette',
	'Class:VCSApplication/Attribute:name+' => 'Etiquette libre dévrivant le webhook',
	'Class:VCSApplication/Attribute:provider' => 'Fournisseur',
	'Class:VCSApplication/Attribute:provider+' => 'Fournisseur du système de gestion de versions',
	'Class:VCSApplication/Attribute:provider/Value:github' => 'GitHub',
	'Class:VCSApplication/Attribute:mode' => 'Mode d\'authentification',
	'Class:VCSApplication/Attribute:mode+' => 'Mode d\'authentification pour accéder à l\'API du VCS',
	'Class:VCSApplication/Attribute:mode/Value:personal' => 'Jeton d\'accès personel',
	'Class:VCSApplication/Attribute:mode/Value:app' => 'Jeton d\'accès à l\'installation de l\'application',
	'Class:VCSApplication:personal_access_token' => 'Jeton d\'accès personel',
	'Class:VCSApplication/Attribute:personal_access_token' => 'Jeton',
	'Class:VCSApplication/Attribute:personal_access_token+' => 'Jeton pour l\'accès à l\'API',
	'Class:VCSApplication:app_organization' => 'Application installée sur une organisation',
	'Class:VCSApplication/Attribute:app_organization_name' => 'Organisation',
	'Class:VCSApplication/Attribute:app_organization_name+' => 'Organisation GitHub attachée au connecteur',
	...
	'Class:VCSApplication/UI:Button:revoke_token' => 'Regénérer le jetton d\'accès',

	// CLASS lnkContactToVCSWebhook
	'Class:lnkContactToVCSApplication' => 'Lien Contact / Application',
	...
	'Class:lnkVCSAutomationToVCSApplication:condition' => 'Conditions d\'Execution (1 ET 2 ET 3 => Exécution)',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:status' => 'Statut',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:status+' => 'Statut de l\'automatisme pour le Webhook lié',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:status/Value:active' => 'Actif',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:status/Value:inactive' => 'Inactif',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:condition_1' => 'Condition 1',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:condition_1+' => 'Exemple: ref=refs/heads/(develop|support|feature).*',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:condition_2' => 'Condition 2',
	'Class:lnkVCSAutomationToVCSApplication/Attribute:condition_2+' => 'Exemple: repository->name=my-repository',
